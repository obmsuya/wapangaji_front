...
const TenantCard = () => {
    ...
    return (
        <Animated.View entering={FadeIn} exiting={FadeOut} className="flex-row gap-2 justify-between items-center">
            <View className="w-10 h-10 bg-gray-200 rounded-full justify-center items-center">
                <Text className="text-center self-center">1</Text>
            </View>
            <View>
                <Text className="text-xl">Steve Salehe</Text>
                <Text className="text-gray-500">Room: 1, 30 Aug 2024</Text>
            </View>
            <View>
                <Text className="text-xl">Tsh 150,000.00</Text>
                <Text className="self-end text-gray-500">per month</Text>
            </View>
            <View>
                <TenantDropdownMenu
